 ...
 * Use the [UbicacionesIgnis.newInstance] factory method to
 * create an instance of this fragment.
 */
class UbicacionesIgnis : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_ubicaciones_ignis, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment UbicacionesIgnis.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UbicacionesIgnis().apply {
